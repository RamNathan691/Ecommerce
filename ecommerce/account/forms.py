...
class UserAdminChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('email', 'password', 'active', 'admin','FirstName','LastName')
...
class LoginForm(forms.Form):
    username = forms.EmailField(widget=forms.EmailInput(attrs={'class':'form-control','placeholder':'Enter the USERNAME'}))
